...
# ZenMoney
ZENMONEY_API_TOKEN=your_zenmoney_token
ZENMONEY_API_URL=https://api.zenmoney.ru/v8
...
### О платформе Pella.app

Pella.app - это современная платформа для развертывания и хостинга приложений с поддержкой:
...
3. **Настройка переменных окружения** в Pella.app:
   - Перейдите в настройки проекта в Pella.app
...
3. **Настройка домена**:
   - Pella.app автоматически предоставляет поддомен
   - Можно настроить собственный домен
   - SSL сертификат настраивается автоматически

### Настройка Telegram Webhook

После развертывания на Pella.app:

1. **Получите URL приложения**:
   ```
   https://your-app-name.pella.app
   ```
...
2. **Настройте Webhook**:
   ...
   curl -X POST "https://api.telegram.org/bot<YOUR_BOT_TOKEN>/setWebhook" \
        ...
        -d '{"url": "https://your-app-name.pella.app/webhook"}'
   ```
...
Pella.app предоставляет встроенные инструменты:
